...
#define VER_FILE_VERSION MIOPEN_VERSION_MAJOR, MIOPEN_VERSION_MINOR, MIOPEN_VERSION_PATCH, 0
#define VER_FILE_VERSION_STR \
    STRINGIZE(MIOPEN_VERSION_MAJOR) \
    "." STRINGIZE(MIOPEN_VERSION_MINOR) "." STRINGIZE(MIOPEN_VERSION_PATCH) "." STRINGIZE(0)
